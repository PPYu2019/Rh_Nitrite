...
def get_rates(theta,kf,kr):
   ...
   rate [19] = kf [19] * tNH2 * tNH2           - kr [19] * tN2H4 * tstar   # 2NH2* <--> N2H4* + *
   rate [20] = kf [20] * tN2H4                 - kr [20] * PN2H4 * tstar   # N2H4* <--> N2H4 + *
   return rate
...
#Reaction energies
#To run the model at any pH, remove the comment at the start of the line in both reaction energies and activation barriers sections
#E = [-2.908, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.528, 0.656, -1.778, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #3.25
...
#E = [-2.804, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.632, 0.656, -1.674, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #5
#E = [-2.745, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.692, 0.656, -1.614, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #6
#E = [-2.685, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.751, 0.656, -1.555, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #7
#E = [-2.626, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.811, 0.656, -1.495, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #8
#E = [-2.566, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.870, 0.656, -1.436, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #9
#E = [-2.507, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.885, 0.656, -1.376, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #10
#E = [-2.447, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.885, 0.656, -1.317, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #11
#E = [-2.387, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.885, 0.656, -1.257, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #12
#E = [-2.328, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.885, 0.656, -1.198, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #13
#E = [-2.268, -1.165, 0.06, -0.85, 0.22, -0.256, 0.323, -0.153, 0.885, 0.656, -1.138, -1.64, 0.501, 0.599, 0.449, -1.133, 0.351, -1.708, -1.839, 1.039, 1.449] #14
...
#Activation Barriers
#To run the model at any pH, remove the comment at the start of the line in both reaction energies and activation barriers sections
#E = [0.000, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.528, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=3.25
...
#E = [0.104, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.632, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=5
#E = [0.164, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.692, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=6
#E = [0.223, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.751, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=7
#E = [0.283, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.811, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=8
#E = [0.342, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.870, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=9
#E = [0.402, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.885, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=10
#E = [0.461, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.885, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=11
#E = [0.521, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.885, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=12
#E = [0.581, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.885, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ]  #pH=13
#E = [0.640, 0.000, 0.825 *A , 1.432 *A , 1.250 *A , 0.892 *A , 1.164 *A , 1.053 *A , 0.885, 0.656, 0.0, 0.267*A, 1.621 *A, 1.492*A, 1.34*A, 0.70*A, 0.73*A, 0.75*A, 0.0, 1.524 *A, 1.449 ] #pH=14
